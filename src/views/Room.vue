<template>
  ...
  <div class="game-rule-dialog" v-if="showGameRule">
    <div class="content">
      ...
      <div class="desc">
        <p>一、 基础参与规则</p>
        <p>1. 账号登录：玩家通过手机号注册或第三方账号登录，完成实名认证后即可进入游戏；</p>
        <p>2. 消耗与启动：选择对应弹珠机台，消耗指定数量游戏币即可开启一局游戏；游戏币可通过任务奖励、会员签到、购买等途径获取。</p>
        <p>3. 核心操作：点击屏幕上的投珠按钮投入弹珠，随后拉动屏幕内的拉杆，弹珠会随拉杆摆动轨迹弹射进入轨道，在轨道内碰撞触发各类奖励机制。</p>
        <p>二、 奖励获取规则</p>
        <p>1. 弹珠奖励：弹珠在轨道内撞击“弹珠补给口”，可直接获得对应数量的弹珠，弹珠可继续投入游戏，延长单局游玩时长。</p>
        <p>2. 积分卡片奖励</p>
        <p>◦ 弹珠撞击轨道内的，可掉落对应的卡片，卡片数量越多，兑换的积分礼品具价值越高。</p>
        <p>◦ 收集卡片，可在游戏内“商城”兑换礼品。</p>
        <p>三、 违规与安全规则</p>
        <p>1. 公平规范：严禁使用外挂、修改器等作弊工具干预游戏数据，一经检测核实，将立即封禁账号，清空账号内所有道具及游戏币。</p>
        <p>2. 消费规则：游戏内充值项目价格公示透明，充值获得的虚拟物品仅限本APP内使用，不支持提现或兑换现金。</p>
        <p>3. 账号安全：请勿向他人泄露账号密码，因账号共享、被盗导致的损失，由玩家自行承担；建议绑定手机号开启登录保护。</p>
        <p>本规则最终解释权归“缤果邦弹珠”运营团队所有，运营团队有权根据游戏运营情况调整规则，调整内容将通过APP内公告提前通知玩家。</p>
      </div>
    </div>
