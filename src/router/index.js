...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/setting', name: 'setting', component: () => import('../views/Setting.vue') },
    {
      path: '/account-cancel',
      name: 'account-cancel',
      component: () => import('../views/AccountCancel.vue'),
    },
    {
      path: '/edit-user-info',
      name: 'edit-user-info',
    ...
    },
    {
      path: '/aggrement/:type',
      name: 'aggrement',
      component: () => import('../views/Aggrement.vue'),
    },
    ...
    { path: '/use-record', name: 'use-record', component: () => import('../views/UseRecord.vue') },
    {
      path: '/ball-record',
      name: 'ball-record',
      component: () => import('../views/BallRecord.vue'),
    },
    {
    ...
    {
      path: '/point-card-record',
      name: 'point-card-record',
      component: () => import('../views/PointCardRecord.vue'),
    },
    { path: '/invitation', name: 'invitation', component: () => import('../views/Invitation.vue') },
    {
      path: '/settlement/:source?',
      name: 'settlement',
      component: () => import('../views/Settlement.vue'),
    },
    { path: '/order/:status?', name: 'order', component: () => import('../views/Order.vue') },
